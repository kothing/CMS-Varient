							...
							if (!empty($files)):
								foreach ($files as $file): ?>
									<div id="post_selected_file_<?php echo $file->post_file_id; ?>" class="item">
										...
										<div class="right">
											<a href="javascript:void(0)" class="btn btn-sm btn-selected-file-list-item btn-delete-selected-file-database" data-value="<?php echo $file->post_file_id; ?>"><i class="fa fa-times"></i></a></p>
										</div>
									</div>
								<?php endforeach;
							endif;
