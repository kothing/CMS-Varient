                ...
                <div class="form-group">
                    ...
                    <select name="text_editor_lang" class="form-control" required>
                        <?php foreach ($ed_langs as $ed_lang): ?>
                            <option value="<?php echo $ed_lang['short']; ?>" <?php echo ($ed_lang['short'] == $this->general_settings->text_editor_lang) ? 'selected' : ''; ?>><?php echo $ed_lang['name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="language_order" placeholder="<?php echo trans('order_1'); ?>" value="1" min="1" max="3000" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid"
                                ...
                                <tr role="row">
                                    ...
                                    <th><?php echo trans('short_form'); ?></th>
                                    <th></th>
                                ...
                                <?php foreach ($languages as $item): ?>
                                    <tr>
                                        ...
                                        <td><?php echo html_escape($item->short_form); ?></td>
