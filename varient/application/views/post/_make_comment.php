...
<?php if ($this->auth_check): ?>
    <form id="make_comment_registered">
        ...
        <div class="form-group">
            <textarea name="comment" class="form-control form-input form-textarea" placeholder="<?php echo trans("comment"); ?>"></textarea>
        </div>
...
<?php else: ?>
    <form id="make_comment">
        ...
        <div class="form-group">
            ...
            <textarea name="comment" class="form-control form-input form-textarea" maxlength="4999" placeholder="<?php echo trans("comment"); ?>"></textarea>
        </div>
